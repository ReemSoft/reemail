...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-ClSplbi0.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B51wp4D-.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C3oSEjGG.mjs"),
		import("./start-BOBu4xcb.mjs"),
